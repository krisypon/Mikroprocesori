...
int main(void)
{
	...
	while(1){
			if ((P2IN & 0b11000000) == 0b10000000 || (P2IN & 0b11000000) == 0b00000000 ) {// PB6 = on  PB7 = off
				P1DIR = P1DIR & 0b00111100; //GGRRGGRR
			} else {
				P1DIR = P1DIR | 0b11000011; //GGRRGGRR
			}
			if ((P2IN & 0b11000000) == 0b01000000 || (P2IN & 0b11000000) == 0b00000000) {// PB6 = off  PB7 = on
